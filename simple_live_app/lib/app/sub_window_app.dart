  ...
  Widget _buildApp() {
    ...
    try {
      ...
      return const MaterialApp(
          home: Scaffold(body: Center(child: Text('参数解析失败'))));
    }
    ...
    if (site == null || roomId == null) {
      return const MaterialApp(
          home: Scaffold(body: Center(child: Text('无效的直播间参数'))));
    }

    final styleColor = Color(AppSettingsController.instance.styleColor.value);
      ...
      initialBinding: BindingsBuilder(() {
        Get.put(
          LiveRoomController(
            pSite: site,
            pRoomId: roomId,
            openedAt: DateTime.tryParse(params['openedAt']?.toString() ?? ''),
          ),
        );
      }),
